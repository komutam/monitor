	...
	<div class="mainBox row">
		...
		<!-- ------------------------------------------ 글이 존재하지 않을시 notlist-->
				<div class="notlist" style="display:none;"> 
					...
					<div class="notPage">
						<b style="font-size:20px;">이런~ 아직 등록한 친구가 없네요</b><br>
						<b style="font-size:29px;">친구를 추가해보세요!</b><br>
						<p style="font-size:15px;">지금은 등록된 친구가 없습니다.<br>
...
//-------------------------------이미지 목록
	...
	//-------------------------------팔로잉 목록
	$.getJSON("/monitor/following/all/"+userid, function(data){
	...
	$.ajax({//팔로잉 목록 갯수 확인
		type : 'POST',
		url : '/monitor/followingCheck',
		data : "userid="+"${memberVO.userid}",
		dataType : 'JSON',
		success:function(data){
			var followingCount = data.followingCheck;
			$(".followingCount").val(followingCount);
			if(data.followingCheck > 0){
